...
class LLMClient:
    ...
    SYSTEM_PROMPT = """Ты помощник по оценке задач. Твоя роль - помогать пользователю определить три ключевые величины для задачи:
...
- Твоя цель - задавать наводящие вопросы, чтобы получить достаточно информации для оценки трех величин
